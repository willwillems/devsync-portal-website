  ...
  <div>
    ...
    <main class="main">
      ...
      <section class="section">
        <h1 class="section-description"> How? </h1>
        ...
        <p class="section-body">Portal provides an intelligent context-aware editor-linked text editor in you browser, in essence a 2-way linked portal to your editor. You’ll be able to click an element and edit the relevant classes, getting immediate visual feedback and automatically having the changes applied in your editor.</p>
      </section>
      <section class="section">
...
.section-body {
  @apply py-1 my-1 text-2xl font-normal leading-normal max-w-3xl;
  color: #ded2cb;
  line-height: 1.5em;
}
